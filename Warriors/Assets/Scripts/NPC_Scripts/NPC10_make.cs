...
public class NPC10_make : MonoBehaviour, IAnimEventListener
{
    ...
    void Awake()
    {
        ...
        NPC10_struct.add_speed_label.GetComponent<UILabel>().text = "+0%";
    ...
    public void init () {
        ...
        if (npc10_char.armor_enable == 1)
        {
            ...
            GameData_weapon.get_armor_skill_func(someValue, 9);
        ...
        if (npc10_char.wing_enable == 1)
        {
            ...
            print("npc10이 현재 장착하고 있는 wing index : " + equip_wing_index);
            GameData_weapon.get_wing_skill_func(equip_wing_index, popup_window_button_mgr.NPC_INDEX.NPC10);
    ...
    public void change_clothes(int enable, int index, int color, string clothes_type)
    {
        ...
        // Boss Scene Load시 사용할 character image;
        npc10_char.armor_enable = enable;
