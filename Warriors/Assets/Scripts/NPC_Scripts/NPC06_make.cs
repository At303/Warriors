...
public class NPC06_make : MonoBehaviour, IAnimEventListener
{
    ...
    public static float npc6_saved_attack_speed = 0f;
    ...
    public void init () {
        ...
        if (npc06_char.armor_enable == 1)
        {
            ...
            GameData_weapon.set_data_for_equip_armor(someValue, 5);
        ...
        if (npc06_char.wing_enable == 1)
        {
            ...
            GameData_weapon.set_data_for_equip_wing(character.Info.wing_part, character.Info.wing_index, popup_window_button_mgr.NPC_INDEX.NPC06);
    ...
    {
        npc6_saved_attack_speed = NPC06_struct.attack_speed;
        NPC06_struct.attack_speed = NPC06_struct.attack_speed * 0.5f;
    }
    public void reset_attack_speed()
    {
        NPC06_struct.attack_speed = npc6_saved_attack_speed;
    }
}
