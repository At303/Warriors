...
public class NPC08_make : MonoBehaviour, IAnimEventListener
{
    ...
    public static float npc8_saved_attack_speed = 0f;
    ...
    public void init () {
        ...
        if (npc08_char.armor_enable == 1)
        {
            ...
            GameData_weapon.set_data_for_equip_armor(someValue, 7);
        ...
        if (npc08_char.wing_enable == 1)
        {
            ...
            GameData_weapon.set_data_for_equip_wing(character.Info.wing_part, character.Info.wing_index, popup_window_button_mgr.NPC_INDEX.NPC08);
    ...
    {
        npc8_saved_attack_speed = NPC08_struct.attack_speed;
        NPC08_struct.attack_speed = NPC08_struct.attack_speed * 0.5f;
    }
    public void reset_attack_speed()
    {
        NPC08_struct.attack_speed = npc8_saved_attack_speed;
    }
}
