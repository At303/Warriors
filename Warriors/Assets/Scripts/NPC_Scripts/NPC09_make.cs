...
public class NPC09_make : MonoBehaviour, IAnimEventListener
{
    ...
    void Start()
    {
        ...
        if (check_npc_enable == 1)
        {
            ...
            NPC09_struct.gameobject.SetActive(true);                 // npc5 캐릭터 활성화.
            init();
        }
        else
        {
    ...
    public void init () {
        ...
        if (npc09_char.armor_enable == 1)
        {
            ...
            NPC09_struct.clothes_sp.spriteName = character.Info.armor_part + character.Info.armor_index.ToString();
    ...
    public void OnAnimation_Hitting(int _index)
    {
        ...
        if (!opened_chest_box.enable_disable_chest_open)
        {
            if (GameData.chest_struct._HP <= 0)
            {
                ...
                // Chest box HP modify
                GameData.chest_struct._HP = GameData.chest_struct._HP - NPC09_struct.damage;
    ...
    public void levelup_npc09_data_struct(int Level)
    {
        ...
        NPC09_struct.damage = (ulong)(NPC09_struct.Level * 2 + 7) + NPC09_struct.add_damage;
