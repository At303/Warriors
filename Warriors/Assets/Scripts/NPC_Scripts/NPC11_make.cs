...
public class NPC11_make : MonoBehaviour, IAnimEventListener
{
    ...
    public void init () {
        ...
        if (npc11_char.armor_enable == 1)
        {
            ...
            NPC11_struct.clothes_sp.spriteName = character.Info.armor_part + character.Info.armor_index.ToString();
    ...
    public void levelup_npc11_data_struct(int Level)
    {
        ...
        NPC11_struct.damage = (ulong)(NPC11_struct.Level * 2 + 7) + NPC11_struct.add_damage;
