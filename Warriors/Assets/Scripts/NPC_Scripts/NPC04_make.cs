...
public class NPC04_make : MonoBehaviour, IAnimEventListener
{
    ...
    void Awake()
    {
        ...
        NPC04_struct.gameobject = GameObject.Find("_NPC04_gameobj");
        NPC04_struct.npc_enable = GameObject.Find("_npc4_enable");                                             // NPC02하위 요소들을 enable할지 말지 결정할 val.
                                                                                                               // NPC GameObject.    
        ...
        NPC04_struct.add_speed_label.GetComponent<UILabel>().text = "+0%";

        NPC04_struct.skill_label = GameObject.Find("_npc04_skill_label");
    ...
    void Start()
    {
        ...
        else
        {
            ...
            NPC04_struct.npc_enable.SetActive(false);   // npc 하위 변수들 비활성화. ( 해당 npc가 enable이 아닌데도 버튼이 눌려지는 현상을 해결하기 위함. )
        ...
        {
            NPC04_struct.npc_enable.SetActive(true);
    ...
    public void init()
    {
        ...
        if (npc04_char.weapon_enable == 1)
        {
            ...
            print(character.Info.main_weapon_part);
            print(character.Info.main_weapon_index);
        ...
        if (npc04_char.armor_enable == 1)
        {
            ...
            GameData_weapon.get_armor_skill_func(someValue, 3);
        ...
        if (npc04_char.wing_enable == 1)
        {
            ...
            print("npc4이 현재 장착하고 있는 wing index : " + equip_wing_index);
            GameData_weapon.get_wing_skill_func(equip_wing_index, popup_window_button_mgr.NPC_INDEX.NPC04);
    ...
    public void levelup_npc04_data_struct(int Level)
    {
        ...
        // 캐릭터 공격력도 누적.
        NPC04_struct.damage = 0;

        for (int i = 1; i < Level + 1; i++)
        {
            NPC04_struct.damage = NPC04_struct.damage + (ulong)(320 * Mathf.Pow(1.275f, i) + 10);
        }

        // =POWER(1.325,A2)*10000
        NPC04_struct.upgrade_cost = (ulong)Mathf.Round(Mathf.Pow(1.325f, Level) * 500000);
        ...
        if (NPC04_struct.Level == 3)
        {
            ...
            NPC05_make.NPC05_struct.npc_enable.SetActive(true);
        }
    }
    ...
    public void update_npc04_data_label()
    {
        ...
        NPC04_struct.lvup_cost_label.GetComponent<UILabel>().text = GameData.int_to_label_format_won(NPC04_struct.upgrade_cost);
    ...
    public void change_weapon(int enable,int weapon_index, string weapon_name)
    {
        ...
        npc04_char.weapon_enable = enable;
        npc04_char.weapon_part = weapon_name;
        npc04_char.weapon_index = weapon_index;

        // Local에 npc1 weapon 이미지 저장.
        PlayerPrefs.SetInt("npc4_weapon_enable", npc04_char.weapon_enable);
        PlayerPrefs.SetString("npc4_weapon_part", npc04_char.weapon_part);
        PlayerPrefs.SetInt("npc4_weapon_index", npc04_char.weapon_index);
        PlayerPrefs.Save();
    ...
    public void change_clothes(int enable, int index, int color, string clothes_type)
    {
        ...
        // Boss Scene Load시 사용할 character image;
        npc04_char.armor_enable = enable;
    ...
    public void change_attack_speed(float speed, float anim_speed)
    {
        ...
        saved_attack_speed = NPC04_struct.attack_speed;
        
        NPC04_struct.attack_speed = 1 * speed;
        anim.speed = anim_speed;

    }
    public void reset_attack_speed()
    {
        NPC04_struct.attack_speed = 1;
    }
      ...
      public void ads_reset_attack_speed()
    {
        ...
        NPC04_struct.attack_speed = saved_attack_speed;
    }
