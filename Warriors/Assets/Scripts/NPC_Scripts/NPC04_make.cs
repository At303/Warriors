...
public class NPC04_make : MonoBehaviour, IAnimEventListener
{
    ...
    public static float npc4_saved_attack_speed = 0f;
    ...
    public void init()
    {
        ...
        if (npc04_char.armor_enable == 1)
        {
            ...
            GameData_weapon.set_data_for_equip_armor(someValue, 3);
        ...
        if (npc04_char.wing_enable == 1)
        {
            ...
            GameData_weapon.set_data_for_equip_wing(character.Info.wing_part, character.Info.wing_index, popup_window_button_mgr.NPC_INDEX.NPC04);
    ...
    {
        npc4_saved_attack_speed = NPC04_struct.attack_speed;
        NPC04_struct.attack_speed = NPC04_struct.attack_speed * 0.5f;
    }
    public void reset_attack_speed()
    {
        NPC04_struct.attack_speed = npc4_saved_attack_speed;
    }
}
