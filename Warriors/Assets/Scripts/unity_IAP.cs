...
public class unity_IAP : MonoBehaviour,IStoreListener
 ...
 private static IStoreController m_StoreController;                                                                  // Reference to the Purchasing system.
        ...
        private static string kProductID2000won =  "gemstone_2000won";                                                   // General handle for the subscription product.
        private static string kProductID1000won =  "test_gemstone_1000won";                                                   // General handle for the subscription product.
        ...
        private static string kProductNameGooglePlayInAppPurchase02 =  "gemstone.20ea";  // Google Play Store identifier for the subscription product.
        private static string kProductNameGooglePlayInAppPurchase01 =  "test_gemstone_1000won";  // Google Play Store identifier for the subscription product.
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
        {
            ...
            {
                NGUIDebug.Log  (string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));//If the consumable item has been successfully purchased, add 100 coins to the player's in-game score.
                //ScoreManager.score += 100;
            }
            else if (String.Equals(args.purchasedProduct.definition.id, kProductID2000won, StringComparison.Ordinal))
            {
                NGUIDebug.Log (string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));}// Or ... a subscription product has been purchased by this user.
